...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(55183);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(64998),
    __webpack_require__(15527),
    __webpack_require__(84257),
  ...
  let baseMods = [
      __webpack_require__(52238),
  __webpack_require__(56084),
  __webpack_require__(39963),
  __webpack_require__(45807),
  __webpack_require__(43384),
  __webpack_require__(51974),
  __webpack_require__(92829),
  
      (__webpack_require__(14874)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(1713)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(45457),
  
      (__webpack_require__(77343)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(32718)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(54105),
  
      (__webpack_require__(23100)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(8410)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(78519)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(93927)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(55553)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(48234),
  __webpack_require__(71713),
  __webpack_require__(18420),
  
      (__webpack_require__(42556)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(75039),
  __webpack_require__(76426),
  __webpack_require__(31302),
  
      (__webpack_require__(68717)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
  ...
  __webpack_require__(45010),
  __webpack_require__(6199),
  __webpack_require__(32950),
  __webpack_require__(5616),
  __webpack_require__(95086),
  __webpack_require__(97862),
  __webpack_require__(19866),
  __webpack_require__(27620),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(59359),
  
      (__webpack_require__(44334)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(76393),
  ...
  __webpack_require__(43769),
  
      (__webpack_require__(89197)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(27230)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(39742)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(52387).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(38984).IServiceManager);
...
//# sourceMappingURL=8781.d22825cc38dd63ea198a.js.map?v=d22825cc38dd63ea198a